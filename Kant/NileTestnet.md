...
This document outlines the Nile testnet tasks that need to be completed to make Kant ready for Nile testnet launch. **Last updated May 13, 2025.**

Note: The target version number of Kant is v4.8.0.2 .
...
Estimated Nile upgrade time: about 15 days (2025.03.05 ~ 2025.04.03)

- [x] Notify the community to upgrade (2025.03.05)
- [x] Follow up to remind the community to complete the upgrade (2025.04.03)
